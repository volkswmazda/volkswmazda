window.VMZ_CONFIG = {
  ...
  // Ciudad / dirección mostrada en la sección de contacto y footer
  ...
  /* ------------------------------------------------------------
     ...
     Texto pre-cargado según el botón que presione el usuario.
     ------------------------------------------------------------ */
  ...
  /* ------------------------------------------------------------
     ...
     ------------------------------------------------------------ */
  contactScriptUrl: 'https://script.google.com/macros/s/AKfycby2ttC4i37DTiG2XFFfxNSQd_wpwOsy5CsAqpEiq0KBfXV8-kZFMLrXFojLOsvrJ_UFbQ/exec',
